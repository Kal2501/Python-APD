...
# Fungsi untuk menampilkan film di dalam dictionary cinema
def showList():
    if not cinema:
...
# Fungsi untuk menampilkan review film (admin)
def lihat_review_film():
    showList()
    try:
        nomor_film = int(input("Pilih nomor film (0 untuk kembali): "))
        os.system('cls')
        nomor_film -= 1
        if nomor_film == -1 :
            return
...
# Fungsi untuk menghapus review film (admin)
...
# Fungsi untuk menambah judul film (admin)
...
# Fungsi untuk mengubah judul film (admin)
def ubah_judul_film():
    showList()
    try:
...
# Fungsi untuk menghapus judul film (admin)
...
# Fungsi untuk menampilkan review film (user)
...
# Fungsi untuk memberi review pada judul film (user)
...
# Fungsi untuk mengubah review film (user)
...
# Fungsi untuk menghapus review film (user)
